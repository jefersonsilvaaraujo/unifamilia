...
export const gameModes: GameMode[] = [
  ...
  },
  {
    ...
    name: "Normal",
    shortName: "Normal",
    description: "Mais pressao, 4 fases, obstaculos novos e portal exige parte dos bits.",
    startingLives: 3,
    startTime: 64,
  ...
  },
  {
    ...
    name: "Desafio",
    shortName: "Desafio",
    description: "5 fases, bugs mais rapidos, todos os bits obrigatorios e bonus por precisao.",
    startingLives: 2,
    startTime: 56,
